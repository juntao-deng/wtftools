...
public class ScuNewNodeProjectPage2 extends WizardPage implements  IPropertyChangeListener, IDialogFieldListener{
	...
	public ScuNewNodeProjectPage2(ISelection selection) {
	...
	public void createControl(Composite parent){
		...
		homePageField = createCheckBoxField("With Home Pages", composite);
